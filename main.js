...
function switch_report(id){
    ...
    $('#btn_table').click(function() {$('#report_div').html("");$('#report_div').append('<br/><table id="report_table"><thead></thead><tbody></tbody></table><br/>');ConvertJsonToTable(db.tables[$("#table_selector").val()].data, "report_table", null, "test");/*$('#report_table').DataTable();*/}); 
}
